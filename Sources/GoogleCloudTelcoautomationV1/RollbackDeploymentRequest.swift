...
public struct RollbackDeploymentRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RollbackDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RollbackDeploymentRequest().with { $0.name = ... }
  /// ```
