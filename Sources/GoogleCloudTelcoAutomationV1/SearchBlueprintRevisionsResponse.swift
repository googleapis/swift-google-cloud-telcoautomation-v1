...
public struct SearchBlueprintRevisionsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of requested blueprint revisions.
  public var blueprints: [Blueprint] = []
  ...
  /// Initialize a new instance of `SearchBlueprintRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchBlueprintRevisionsResponse().with { $0.blueprints = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Blueprint].self, forKey: .blueprints) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.telcoautomation.v1.SearchBlueprintRevisionsResponse"
  }
