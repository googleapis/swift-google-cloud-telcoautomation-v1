...
public struct ListBlueprintsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListBlueprintsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBlueprintsResponse().with { $0.blueprints = ... }
  /// ```
