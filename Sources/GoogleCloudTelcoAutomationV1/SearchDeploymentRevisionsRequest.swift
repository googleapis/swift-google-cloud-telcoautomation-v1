...
public struct SearchDeploymentRevisionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchDeploymentRevisionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchDeploymentRevisionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.telcoautomation.v1.SearchDeploymentRevisionsRequest"
  }
