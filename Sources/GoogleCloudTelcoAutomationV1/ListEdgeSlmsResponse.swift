...
public struct ListEdgeSlmsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of EdgeSlm
  public var edgeSlms: [EdgeSlm] = []
  ...
  /// Initialize a new instance of `ListEdgeSlmsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEdgeSlmsResponse().with { $0.edgeSlms = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let edgeSlms = CodingKeys(stringValue: "edgeSlms")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([EdgeSlm].self, forKey: .edgeSlms) {
      self.edgeSlms = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.edgeSlms, forKey: .edgeSlms)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.telcoautomation.v1.ListEdgeSlmsResponse"
  }
