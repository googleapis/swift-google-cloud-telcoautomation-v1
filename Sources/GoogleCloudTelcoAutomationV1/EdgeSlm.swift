...
/// Cluster.
public struct EdgeSlm: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum WorkloadClusterType: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("WORKLOAD_CLUSTER_TYPE_UNSPECIFIED")
      case .gdce: return try container.encode("GDCE")
