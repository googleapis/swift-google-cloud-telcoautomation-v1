...
public struct ListOrchestrationClustersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of OrchestrationCluster
  public var orchestrationClusters: [OrchestrationCluster] = []
  ...
  /// Initialize a new instance of `ListOrchestrationClustersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOrchestrationClustersResponse().with { $0.orchestrationClusters = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let orchestrationClusters = CodingKeys(stringValue: "orchestrationClusters")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [OrchestrationCluster].self, forKey: .orchestrationClusters)
    {
      self.orchestrationClusters = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.orchestrationClusters, forKey: .orchestrationClusters)
  ...
  public func _getPaginatedItems() -> [OrchestrationCluster] {
    return self.orchestrationClusters
  }
