  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListBlueprintRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBlueprintRevisionsResponse().with { $0.blueprints = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.telcoautomation.v1.ListBlueprintRevisionsResponse"
  }
