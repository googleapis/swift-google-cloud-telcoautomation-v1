...
public struct HydratedDeployment: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var state: HydratedDeployment.State = HydratedDeployment.State()
  ...
  ///
  /// ```
  /// let value = HydratedDeployment().with { $0.name = ... }
  /// ```
