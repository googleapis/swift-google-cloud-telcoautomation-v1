...
public struct ListDeploymentRevisionsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDeploymentRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDeploymentRevisionsResponse().with { $0.deployments = ... }
  /// ```
