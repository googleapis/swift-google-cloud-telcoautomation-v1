  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDeploymentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDeploymentsResponse().with { $0.deployments = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.telcoautomation.v1.ListDeploymentsResponse"
  }
