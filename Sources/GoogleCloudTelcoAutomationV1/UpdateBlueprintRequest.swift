...
public struct UpdateBlueprintRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateBlueprintRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateBlueprintRequest().with { $0.blueprint = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.telcoautomation.v1.UpdateBlueprintRequest"
  }
