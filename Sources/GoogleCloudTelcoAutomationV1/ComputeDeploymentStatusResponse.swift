  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let aggregatedStatus = CodingKeys(stringValue: "aggregatedStatus")
    static let resourceStatuses = CodingKeys(stringValue: "resourceStatuses")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.aggregatedStatus, forKey: .aggregatedStatus)
    try container.encode(self.resourceStatuses, forKey: .resourceStatuses)
