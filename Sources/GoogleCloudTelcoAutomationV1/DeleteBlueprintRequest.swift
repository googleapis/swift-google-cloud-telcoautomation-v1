...
public struct DeleteBlueprintRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteBlueprintRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteBlueprintRequest().with { $0.name = ... }
  /// ```
